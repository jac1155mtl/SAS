...
/ Purpose   : To scan for a quoted string in a macro expression.
/ SubMacros : none
/ Notes     : The quoted string will still have its quote marks around it. A null
/             string will be returned if there is nothing quoted.
