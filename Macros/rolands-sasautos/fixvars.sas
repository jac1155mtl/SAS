...
/             and makes no difference and so it is ignored.
/
/             Use the %clash macro if you need to know the source datasets of
/             some of the variables.
/
/             Variables will only be candidates for updating if the variable name
/             matches exactly (it is case sensitive) as does the variable type.
/
