...
/             added that contains the count of the number of observations in each
/             by group. Variables will be given the suffix 1, 2, etc.
...
/ nobs=nobs         Name of the variable to contain the number of observation per
/                   "by group"
/================================================================================
/ AMENDMENT HISTORY:
