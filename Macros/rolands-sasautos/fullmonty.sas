...
/ Purpose   : To do a stacked-column report using data _null_ that does not leave
/             line gaps like proc report does.
/ SubMacros : %titlelen %maxtitle %splitvar %titlegen
/ Notes     : This is an example of using data _null_ to produce a stacked-column
/             report without the weakness of proc report in leaving line gaps. It
/             can handle #byval and #byvar entries in the titles, will generate
/             or not a "by" line depending on the options setting and will center
/             or left-align depending on the "center" option setting. The
/             positioning of the report and titles is dependent on the line size.
/             Report titles are stored in arrays to speed up multi-page reports.
/
...
/             educational tool, rather than a recommendation. Once you understand
/             how it works you should be able to handle data _null_ reports of
