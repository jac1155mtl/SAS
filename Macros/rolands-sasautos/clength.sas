...
/             be blank. Names, labels and other attributes will be taken from the
/             first data set in the list. The length statement string is written
/             out to a global macro variable which can then be resolved in a 
/             later data step.
