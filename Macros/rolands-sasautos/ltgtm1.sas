...
/ Purpose   : To turn a text numeric value into a numeric value and handle "<"
/             and ">" signs preceding and adjust the value according to a rule.
/ SubMacros : none
/ Notes     : The numeric adjustment done where values beging with "<" or ">" may
/             not be the "standard" method for your site. You should ascertain
/             whether a standard method already exists for handling this
/             situation and use that method unless you have special cause to use
/             this macro. This should be used in a data step.
/
