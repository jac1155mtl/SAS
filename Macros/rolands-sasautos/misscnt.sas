...
/             unlike its sister %missvars, has a drop list. You might want to use
/             the output from %missvars to ignore all-missing variables from your
/             analysis.
...
/ drop              List of variables (pos - unquoted and separated by spaces) to
